...
//   const unsigned char Diode[] MEM_TEXT = "Diode: ";
...
#if defined(LANG_POLISH)		// polski
   const unsigned char TestRunning[] MEM_TEXT = "Testowanie...";
   const unsigned char BatWeak[] MEM_TEXT = "słaby";
   const unsigned char BatEmpty[] MEM_TEXT = "pusty!";
   const unsigned char TestFailed2[] MEM_TEXT = "uszkodzony ";
   const unsigned char Component[] MEM_TEXT = "element";
   ...
   const unsigned char TestFailed1[] MEM_TEXT = "Nieznany lub";
   const unsigned char OrBroken[] MEM_TEXT = "lub uszkodzony ";
   const unsigned char TestTimedOut[] MEM_TEXT = "Limit czasu!";
   #define Cathode_char 'K'
 #ifdef WITH_SELFTEST
   const unsigned char SELFTEST[] MEM_TEXT = "Tryb autotestu ..";
   const unsigned char RELPROBE[] MEM_TEXT = "izoluj sonde!";
...
const unsigned char VERSION_str[] MEM2_TEXT = "Tester el. elektr.";
...
void setup()
{
  ...
  #if defined(NOK5110) || defined(OLED096)
    lcd_set_cursor(0, 0);
    lcd_string("Tester el. elektr.");
    lcd_set_cursor(1, 0);
    lcd_string("Marcin Pieczykolan");
  #endif
...
void lcd_set_cursor(uint8_t row, uint8_t col)
{
  ...
  #ifdef OLED096
    display.setCursor(6*col, 10*row+TOP_ROW);
  #endif
...
void lcd_data(unsigned char temp1) {
    ...
    switch(temp1) {
      case LCD_CHAR_DIODE1: {
        display.write('>'); display.write('|'); break;
      }
